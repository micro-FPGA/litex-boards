...
set rc [catch {
  ...
  set_property webtalk.parent_dir X:/GIT/litex-boards/litex_boards/partner/targets/soc_basesoc_te0725/gateware/top.cache/wt [current_project]
  set_property parent.project_path X:/GIT/litex-boards/litex_boards/partner/targets/soc_basesoc_te0725/gateware/top.xpr [current_project]
  set_property ip_output_repo X:/GIT/litex-boards/litex_boards/partner/targets/soc_basesoc_te0725/gateware/top.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet X:/GIT/litex-boards/litex_boards/partner/targets/soc_basesoc_te0725/gateware/top.runs/synth_1/top.dcp
  read_ip -quiet X:/GIT/litex-boards/litex_boards/partner/targets/soc_basesoc_te0725/gateware/top.srcs/sources_1/ip/ila_0/ila_0.xci
  read_xdc X:/GIT/litex-boards/litex_boards/partner/targets/soc_basesoc_te0725/gateware/top.xdc
  link_design -top top -part xc7a35tcsg324-2
